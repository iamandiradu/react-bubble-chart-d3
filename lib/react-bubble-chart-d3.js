  ...
  _createClass(BubbleChart, [{
    ...
    value: function renderChart() {
      var _props3 = this.props,
          ...
          showValue = _props3.showValue,
          showAnimations = _props3.showAnimations,
    ...
    value: function renderBubbles(width, nodes, color) {
      var _props4 = this.props,
          ...
          showAnimations = _props4.showAnimations,
      ...
      var tooltip = d3.select("body").append("div").attr("class", "tooltip").style("position", "absolute").style("opacity", "1").style("z-index", "10").style("visibility", "hidden");
      ...
      node.append("circle").attr("id", function (d) {
        ...
        return tooltip.style("visibility", d.data.customTooltip ? "visible" : "hidden").text(d.data.customTooltip);
